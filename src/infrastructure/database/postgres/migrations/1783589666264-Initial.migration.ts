...
export class InitialMigration1783589666264 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "user"."user_blocks" ("id" BIGSERIAL NOT NULL, "blocker_id" bigint NOT NULL, "blocked_id" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_0bae5f5cab7574a84889462187c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "chat"."messages_type_enum" AS ENUM('TEXT')`,
    );
    await queryRunner.query(
      `CREATE TABLE "chat"."messages" ("id" BIGSERIAL NOT NULL, "text" text NOT NULL, "type" "chat"."messages_type_enum" NOT NULL DEFAULT 'TEXT', "sender_id" bigint NOT NULL, "conversation_id" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "conversationId" bigint, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "chat"."conversations" ("id" BIGSERIAL NOT NULL, "title" character varying, "picture" character varying, "identifier" character varying, "type" "chat"."conversations_type_enum" NOT NULL DEFAULT 'DIRECT', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_ee34f4f7ced4ec8681f26bf04ef" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "conversations_identifier_uniq" ON "chat"."conversations"  ("identifier") `,
    );
    await queryRunner.query(
      `CREATE TABLE "chat"."conversation_members" ("id" BIGSERIAL NOT NULL, "user_id" bigint NOT NULL, "conversation_id" bigint NOT NULL, "last_seen_message_id" bigint, "last_message_id" bigint, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "last_message" bigint, CONSTRAINT "REL_ae81cc388649f0c1348c155c82" UNIQUE ("last_seen_message_id"), CONSTRAINT "REL_9efa90fa4b17f5d32d0ed1466f" UNIQUE ("last_message"), CONSTRAINT "PK_33146a476696a973a14d931e675" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "chat"."deleted_messages" ("id" BIGSERIAL NOT NULL, "user_id" bigint NOT NULL, "message_id" bigint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7152ce9fd05f40828c9bac69654" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
